...
class AmstelvarDesignSpaceBuilder:
    ...
    parametricAxes   = 'XOPQ XOUC XOLC XOFI XTRA XTUC XTLC XTFI YOPQ YTUC YTLC YTAS YTDE YTFI XSHU YSHU XSHL YSHL XSVU YSVU XSHF YSHF XSVL YSVL XTTW YTTL YTOS'.split()
    minValue         = -100
    maxValue         = 100
