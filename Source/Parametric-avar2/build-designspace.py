...
class AmstelvarDesignSpaceBuilder:
    ...
    parametricAxes   = 'XOPQ XOUC XOLC XOFI XTRA XTUC XTLC XTFI YOPQ YTUC YTLC YTAS YTDE YTFI XSHA XSHU XSHL XSHF YSHA YSHU YSHL YSHF XSVU XSVL YSVU YSVL XTTW YTTL YTOS'.split()
    minValue         = -100
    maxValue         = 100
