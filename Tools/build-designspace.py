...
class AmstelvarA2DesignSpaceBuilder:
    ...
    parametricAxesItalic = 'XOUC XOLC XOFI YOUC YOLC YOFI XTUC           XTLC XTLR XTLD XTFI YTUC YTLC YTAS YTDE YTFI XSHU YSHU XSVU YSVU XSHL YSHL XSVL YSVL XSHF YSHF XSVF YSVF                               XTTW YTTL YTOS XUCS XUCR XUCD XLCS XLCR XLCD XFIR WDSP XDOT BARS                              '.split() # parametricAxesRoman
