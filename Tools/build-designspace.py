...
class AmstelvarA2DesignSpaceBuilder:
    ...
    parametricAxesItalic = 'XOUC XOLC XOFI YOUC YOLC YOFI XTUC XTLC XTFI YTUC YTLC YTAS YTDE YTFI XSHU YSHU XSVU YSVU XSHL YSHL XSVL YSVL XSHF      XSVF YSVF XTTW YTTL YTOS XUCS WDSP XDOT'.split()
