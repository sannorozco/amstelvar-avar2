...
class AmstelvarA2DesignSpaceBuilder:
    ...
    parametricAxesRoman  = 'XOUC XOLC XOFI YOUC YOLC YOFI XTUC XTUR XTUD XTLC XTFI YTUC YTLC YTAS YTDE YTFI XSHU YSHU XSVU YSVU XSHL YSHL XSVL YSVL XSHF YSHF XSVF YSVF XTTW YTTL YTOS XUCS XLCS XFIR WDSP XDOT BARS'.split() # GRAD XTEQ YTEQ
