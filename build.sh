...
fontmake -m Sources/Roman/AmstelvarA2-Roman_avar2.designspace -o variable --output-path Fonts/AmstelvarA2-Roman_avar2.ttf --feature-writer None --keep-direction --verbose WARNING
